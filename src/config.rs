...
pub struct ThemeColors {
    ...
    pub graph_queries: Color,
    pub graph_cache: Color,
    pub graph_locks: Color,
...
impl ThemeColors {
    pub const TOKYO_NIGHT: Self = Self {
        ...
        graph_queries: Color::Rgb(152, 195, 121),
        graph_cache: Color::Rgb(86, 182, 194),
        graph_locks: Color::Rgb(224, 108, 117),
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            graph_queries: Color::Rgb(80, 250, 123),
            graph_cache: Color::Rgb(189, 147, 249),
            graph_locks: Color::Rgb(255, 85, 85),
    ...
    pub fn nord() -> Self {
        Self {
            ...
            graph_queries: Color::Rgb(163, 190, 140),
            graph_cache: Color::Rgb(143, 188, 187),
            graph_locks: Color::Rgb(191, 97, 106),
    ...
    pub fn solarized_dark() -> Self {
        Self {
            ...
            graph_queries: Color::Rgb(133, 153, 0),
            graph_cache: Color::Rgb(42, 161, 152),
            graph_locks: Color::Rgb(220, 50, 47),
