...
pub use inspect::{
    ...
    render_replication_inspect, render_schema_erd_inspect, render_settings_inspect,
    render_statement_inspect, render_table_inspect, render_vacuum_inspect,
    render_wraparound_inspect,
};
