...
fn overlay_settings_inspect() {
    ...
    app.server_info.settings = vec![
        PgSetting {
            ...
            short_desc: Some("Sets the number of shared memory buffers used by the server.".to_string()),
        ...
        PgSetting {
            ...
            category: "Resource Usage / Memory".to_string(),
            short_desc: Some("Sets the maximum memory to be used for query workspaces.".to_string()),
...
fn overlay_settings_inspect_pending_restart() {
    ...
    app.server_info.settings = vec![
        PgSetting {
            ...
            short_desc: Some("Sets the maximum number of concurrent connections.".to_string()),
            context: "postmaster".to_string(),
            source: "configuration file".to_string(),
...
fn overlay_settings_inspect_sighup() {
    ...
    app.server_info.settings = vec![
        PgSetting {
            ...
            short_desc: Some("Sets the minimum execution time above which statements will be logged.".to_string()),
...
fn panel_settings_with_data() {
    ...
    app.server_info.settings = vec![
        ...
        PgSetting {
            ...
            unit: Some("8kB".to_string()),
            category: "Resource Usage / Memory".to_string(),
            short_desc: Some("Sets the number of shared memory buffers.".to_string()),
            context: "postmaster".to_string(),
            source: "configuration file".to_string(),
            pending_restart: true,
        },
        PgSetting {
            ...
            unit: Some("kB".to_string()),
            category: "Resource Usage / Memory".to_string(),
            short_desc: Some("Sets the memory for internal sort operations.".to_string()),
            context: "user".to_string(),
            source: "default".to_string(),
            pending_restart: false,
        },
        PgSetting {
            ...
            unit: Some("kB".to_string()),
            category: "Resource Usage / Memory".to_string(),
            short_desc: Some("Sets the memory for maintenance operations.".to_string()),
            context: "user".to_string(),
...
fn panel_settings_with_filter() {
    ...
    app.server_info.settings = vec![
        PgSetting {
            ...
            short_desc: Some("Maximum connections".to_string()),
            context: "postmaster".to_string(),
            source: "configuration file".to_string(),
            pending_restart: false,
        },
        PgSetting {
            ...
            short_desc: Some("Maximum WAL senders".to_string()),
            context: "postmaster".to_string(),
            source: "default".to_string(),
            pending_restart: false,
        },
        PgSetting {
            ...
            short_desc: Some("Work memory".to_string()),
            context: "user".to_string(),
            source: "default".to_string(),
            pending_restart: false,
        },
